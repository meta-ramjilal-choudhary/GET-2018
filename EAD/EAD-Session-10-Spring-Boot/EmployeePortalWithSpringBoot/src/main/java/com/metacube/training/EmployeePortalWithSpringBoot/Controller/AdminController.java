...
import com.metacube.training.EmployeePortalWithSpringBoot.service.JobDetailService;
import com.metacube.training.EmployeePortalWithSpringBoot.service.JobTitleService;
import com.metacube.training.EmployeePortalWithSpringBoot.service.ProjectService;
import com.metacube.training.EmployeePortalWithSpringBoot.service.SkillService;
...
public class AdminController {
	...
	@RequestMapping(path="/employees/profile", method=RequestMethod.GET)
	public String profile(Model model, @RequestParam("id") Long id){
		model.addAttribute("employee", employeeService.getEmployeeById(id));
		return "/admin/employeeDashboard";
	}
	
	//Add Job Detail Page controlling
	@RequestMapping(path="/employees/jobDetails", method=RequestMethod.GET)
	public String getAllJobDetail(Model model, @RequestParam("id") Long id){
		model.addAttribute("jobDetails", jobDetailService.getAllJobDetail());
		return "/admin/jobDetail";
	}
	
	@RequestMapping(path="/employees/addJobDetail", method = RequestMethod.GET)
	public String createJobDetail(Model model){
		model.addAttribute("jobDetail", new JobDetail());
	...
	public String getSearchResult(Model model, @RequestParam("name") String name){
		model.addAttribute("employees", employeeService.getAllEmployeeByName(name));
		return "/admin/employees";
	}
}

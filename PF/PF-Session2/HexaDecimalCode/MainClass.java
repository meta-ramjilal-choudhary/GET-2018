...
public class MainClass {
	...
	public static void main(String args[]) {
		...
		if( !hex.validHex(number1)) {
			System.out.println(number1 + " is not a valid hexadecimal number");
		}
		else if (!hex.validHex(number2)) {
			System.out.println(number2 + " is not a valid hexadecimal number");
		}
		else {
